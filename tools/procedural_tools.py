...
def create_procedural_tools() -> List[Tool]:
    ...
    return [
        Tool(
            ...
            description="Query procedural memory for step-by-step instructions and how-to guides. Use when you need to know HOW to do something. Inputs: query (required), k (optional, default 4)",
